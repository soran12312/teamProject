            ...
            <div class="container-fluid">
               ...
               <div id="navbar" class="navbar-collapse collapse">
                  <ul class="nav navbar-nav navbar-right">
                     ...
                     <li><a data-scroll href="#today_money">추천강좌<span class="hidden-xs">*</span></a></li>
                     <li><a data-scroll href="#today_review">오늘의 강좌</a></li>
                     <li><a data-scroll href="#today_notmoney">오늘의 무료강좌</a></li>
                     <li><a data-scroll href="#today_lesson">오늘의 리뷰</a></li>
