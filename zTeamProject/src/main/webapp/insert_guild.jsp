   ...
   <body class="realestate_version">
      ...
      <header class="header header_style_01">
         ...
         <div class="container">
                  ...
                  <form name="insert_guild_frm" class="insert_guild_frm" id="insert_guild_frm" action="" method="">
                  	
                     	<input type="text" name="insert_guild_title" class="insert_guild_title" id="insert_guild_title" placeholder="제목을 입력해주세요">
                  
                     <div class="insert_sample_img">
                     	<img src="./resources/uploads/agent.jpg">
                    	 <input type="file"  name="insert_guild_img1" class="insert_guild_img1" id="insert_guild_img1">
                  	</div>
                  		
                  		
                    
 <!-- ===옵션=== --><div name="insert_guild_option" class="insert_guild_option" id="insert_guild_option"> <!-- ====================옵션======================================= -->
 						<table>
                    		<tr>
                    			<td>시도 :&nbsp;</td>
                    			<td><select name="insert_guild_addr1" class="insert_guild_addr1" id="insert_guild_addr1">
                    			<option>지역1</option>
                    		</select>
                    			</td>
                    		</tr>
                    		<tr>
                    			<td>시군구 :&nbsp;</td>
                    			<td><select name="insert_guild_addr2" class="insert_guild_addr2" id="insert_guild_addr2">
                    			<option>지역2</option>
                    		</select>
                    			</td>
                    		</tr>
                    		<tr>
                    			<td>읍면동 :&nbsp;</td>
                    			<td><select name="insert_guild_addr3" class="insert_guild_addr3" id="insert_guild_addr3">
                    			<option>지역3</option>
                    		</select>
                    			</td>
                    		</tr>
                    		<tr>
                    			<td>모임인원</td>
                    			<td><input type="number" name="insert_guild_person" class="insert_guild_person" id="insert_guild_person" min="1"></td>
                    			<td>명</td>
                    		</tr>
                     </table>
                    </div>
                    		 <textarea name="insert_guild_content" id="insert_guild_content" class="insert_guild_content" placeholder="모임을 소개해주세요"></textarea></br>
                     <button type="submit" name="insert_guild_submit" id="insert_guild_submit" class="insert_guild_submit">작성완료</button>	
                   </form>
