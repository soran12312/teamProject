...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>품 i Admin </title>
      
      <!-- Favicon -->
      <link rel="shortcut icon" href="resources/images/favicon.png" type="image/x-icon" />
      
      <!-- Library / Plugin Css Build -->
      <link rel="stylesheet" href="resources/userlist/css/core/libs.min.css" />
      
      
      <!-- Hope Ui Design System Css -->
      <link rel="stylesheet" href="resources/userlist/css/hope-ui.min.css" />
      
      <!-- Custom Css -->
      <link rel="stylesheet" href="resources/userlist/css/custom.min.css" />
      
      <!-- Dark Css -->
      <link rel="stylesheet" href="resources/userlist/css/dark.min.css"/>
      
      <!-- Customizer Css -->
      <link rel="stylesheet" href="resources/userlist/css/customizer.min.css" />
      
      <!-- RTL Css -->
      <link rel="stylesheet" href="resources/userlist/css/rtl.min.css"/>
  ...
  <body class="  ">
    ...
    <aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a href="../../main_view.do" class="navbar-brand">
                <!--Logo start-->
                <!--logo End-->
                ...
                <!--logo End-->
			   	...
			   	<div class="logo-main">
                    <div class="logo-normal">
                        <span><img src="resources/images/logos/logo.png" width="215" height="66"></span>  
                    </div>
                    <div class="logo-mini">
                        <span><img src="resources/images/logos/logo.png" width="14.4" height="14.4"></span>
                    </div>
                </div>
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="../../dashboard/app/user-list.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
...
<div>
   <div class="row">
               ...
               <div class="table-responsive">
                  <table id="user-list-table" class="table table-striped" role="grid" data-bs-toggle="data-table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="../../assets/images/shapes/02.png" alt="profile"></td>
                           <td>Brock Lee</td>
                        ...
                        <tr>
                           <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="../../assets/images/shapes/03.png" alt="profile"></td>
                           <td>Dan Druff</td>
                        ...
                        <tr>
                           <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="../../assets/images/shapes/04.png" alt="profile"></td>
                           <td>Hans Olo</td>
                        ...
                        <tr>
                           <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="../../assets/images/shapes/05.png" alt="profile"></td>
                           <td>Lynn Guini</td>
                        ...
                        <tr>
                           <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="../../assets/images/shapes/06.png" alt="profile"></td>
                           <td>Eric Shun</td>
          ...
          <div class="col-lg-12">
            ...
            <div class="d-grid gap-3 grid-cols-2 mb-4">
              <div class="text-center">
                <img src="resources/userlist/images/settings/dark/01.png" alt="ltr" class="mode dark-img img-fluid btn-border p-0 flex-column active mb-2" data-setting="dir-mode" data-name="dir" data-value="ltr">
                <img src="resources/userlist/images/settings/light/01.png" alt="ltr" class="mode light-img img-fluid btn-border p-0 flex-column active mb-2" data-setting="dir-mode" data-name="dir" data-value="ltr">
                <span class=" mt-2"> LTR </span>
              </div>
               <div class="text-center">
                 <img src="resources/userlist/images/settings/dark/02.png" alt="" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="dir-mode" data-name="dir" data-value="rtl">
                  <img src="resources/userlist/images/settings/light/02.png" alt="" class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="dir-mode" data-name="dir" data-value="rtl">
            ...
            <div class="d-grid gap-3 grid-cols-3 mb-4">
              <div class="text-center">
                <img src="resources/userlist/images/settings/dark/03.png" alt="mini" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-mini">
                <img src="resources/userlist/images/settings/light/03.png" alt="mini" class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-mini">
                <span class="mt-2">Mini</span>
              </div>
              <div class="text-center">
               <img src="resources/userlist/images/settings/dark/04.png" alt="hover" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-hover" data-extra-value="sidebar-mini">
               <img src="resources/userlist/images/settings/light/04.png" alt="hover" class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-hover" data-extra-value="sidebar-mini">
                <span class="mt-2">Hover</span>
              </div>
              <div class="text-center">
                 <img src="resources/userlist/images/settings/dark/05.png" alt="boxed" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-boxed">
                 <img src="resources/userlist/images/settings/light/05.png" alt="boxed" class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-boxed">
            ...
            <div class="d-grid gap-3 grid-cols-2 mb-4">
              <div class="text-center">
                <img src="resources/userlist/images/settings/dark/06.png" alt="rounded-one-side" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded">
                <img src="resources/userlist/images/settings/light/06.png" alt="rounded-one-side" class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded">
                <span class="mt-2">Rounded One Side</span>
              </div>
              <div class="text-center">
                <img src="resources/userlist/images/settings/dark/07.png" alt="rounded-all" class="mode dark-img img-fluid btn-border p-0 flex-column active mb-2" data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded-all">
                <img src="resources/userlist/images/settings/light/07.png" alt="rounded-all" class="mode light-img img-fluid btn-border p-0 flex-column active mb-2" data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded-all">
                <span class="mt-2">Rounded All</span>
              </div>
              <div class="text-center">
                 <img src="resources/userlist/images/settings/dark/08.png" alt="pill-one-side" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-item" data-value="navs-pill">
                 <img src="resources/userlist/images/settings/light/09.png" alt="pill-one-side" class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-item" data-value="navs-pill">
                <span class="mt-2">Pill One Side</span>
              </div>
              <div class="text-center">
                 <img src="resources/userlist/images/settings/dark/09.png" alt="pill-all" class="mode dark-img img-fluid btn-border p-0 flex-column" data-setting="sidebar" data-name="sidebar-item" data-value="navs-pill-all">
                 <img src="resources/userlist/images/settings/light/08.png" alt="pill-all" class="mode light-img img-fluid btn-border p-0 flex-column" data-setting="sidebar" data-name="sidebar-item" data-value="navs-pill-all">
            ...
            <div class="d-grid gap-3 grid-cols-2 ">
              <div class=" text-center">
                <img src="resources/userlist/images/settings/dark/11.png" alt="image" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type" data-value="nav-glass">
                <img src="resources/userlist/images/settings/light/10.png" alt="image" class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type" data-value="nav-glass">
                <span class="mt-2">Glass</span>
              </div>
              <div class="text-center">
                 <img src="resources/userlist/images/settings/dark/10.png" alt="color" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar" data-target=".iq-navbar-header" data-name="navbar-type" data-value="navs-bg-color">
                 <img src="resources/userlist/images/settings/light/11.png" alt="color" class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar" data-target=".iq-navbar-header" data-name="navbar-type" data-value="navs-bg-color">
                <span class="mt-2">Color</span>
              </div>
              <div class=" text-center">
                 <img src="resources/userlist/images/settings/dark/12.png" alt="sticky" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type" data-value="navs-sticky">
                 <img src="resources/userlist/images/settings/light/12.png" alt="sticky" class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type" data-value="navs-sticky">
                <span class="mt-2">Sticky</span>
              </div>
              <div class="text-center">
                  <img src="resources/userlist/images/settings/dark/13.png" alt="transparent" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type" data-value="navs-transparent">
                  <img src="resources/userlist/images/settings/light/13.png" alt="transparent" class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type" data-value="navs-transparent">
    ...
    <script src="resources/userlist/js/core/libs.min.js"></script>
    
    <!-- External Library Bundle Script -->
    <script src="resources/userlist/js/core/external.min.js"></script>
    
    <!-- Widgetchart Script -->
    <script src="resources/userlist/js/charts/widgetcharts.js"></script>
    
    <!-- mapchart Script -->
    <script src="resources/userlist/js/charts/vectore-chart.js"></script>
    <script src="resources/userlist/js/charts/dashboard.js" ></script>
    
    <!-- fslightbox Script -->
    <script src="resources/userlist/js/plugins/fslightbox.js"></script>
    
    <!-- Settings Script -->
    <script src="resources/userlist/js/plugins/setting.js"></script>
    
    <!-- Slider-tab Script -->
    <script src="resources/userlist/js/plugins/slider-tabs.js"></script>
    
    <!-- Form Wizard Script -->
    <script src="resources/userlist/js/plugins/form-wizard.js"></script>
    
    <!-- AOS Animation Plugin-->
    
    <!-- App Script -->
    <script src="resources/userlist/js/hope-ui.js" defer></script>
